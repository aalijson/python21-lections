...
"===========None=========="
# None - тип данных с одним значением  None, который используется 
# для обозначение пустых значений или отсутствия значения
bool(None) # False
bool('None') # True
...
"=============Условные операторы============="
# Условные операторы нужны для того, чтобы при разных входных данных
# код работал по разному
if условие1:
    тело1
